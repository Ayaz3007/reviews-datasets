...
data_reviews = pd.read_parquet(r"C:\Users\Admin\Downloads\train.parquet")
...
data_test_reviews = pd.read_parquet(r"C:\Users\Admin\Downloads\test.parquet")
